...
public class Test1_SingleQuery3 {
    ...
    private static int rowSize = 41;

    public static void main(String[] args) {
        PrintWriter pw = null;
        try {
            pw = new PrintWriter(new FileOutputStream("test1-SingleQuery_3.csv"));
        ...
        // columnspec
        //System.out.println("ck1 dist:U[1,10], ck2 dist:U[1,100], ck3 dist:U[1,1000]");
        double step = 1;
        ...
        for (int k = 0; k < cflist.size(); k++) {
            ...
            // H模型代价计算
            H_ian h = new H_ian(198035,ckn, CKdist, 1, qck1r1, qck1r2,true, true,
