...
/*
 ck1 ck2 ck3 have different density
 */
public class diffdata{
    ...
    public static void main(String[] args) {
        ...
        for (int k = 0; k < cflist.size(); k++) { // 控制变量：compare different data models(different ACKSets)
            ...
            // H公式
            HwithoutPrefix h = new HwithoutPrefix(45,65536,1000000,3,data_dist, 1,qck1r1abs,qck1r2abs,new double[]{888,qck1p1abs,qck1p2abs},ackSeq[k]);
