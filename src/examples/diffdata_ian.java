...
/*
 query ck3 which has a density of 1000
 */
public class diffdata_ian{
    ...
    public static void main(String[] args) {
        PrintWriter pw = null;
        try {
            pw = new PrintWriter(new FileOutputStream("diffdata_ian.csv"));
        ...
        // qck3
        int qck3r1 = (int) Math.round(qck3r1abs * (ck3.xmax_ - ck3.xmin_) + ck3.xmin_);
        int qck3r2 = (int) Math.round(qck3r2abs * (ck3.xmax_ - ck3.xmin_) + ck3.xmin_);
        int qck3p1 = (int) Math.round(qck3p1abs * (ck1.xmax_ - ck1.xmin_) + ck1.xmin_);
        int qck3p2 = (int) Math.round(qck3p2abs * (ck2.xmax_ - ck2.xmin_) + ck2.xmin_);
        ...
        for (int k = 0; k < cflist.size(); k++) { // 控制变量：compare different data models(different ACKSets)
            ...
            // H公式
            H_ian h = new H_ian(1000000,ckn, CKdist, 3, qck3r1, qck3r2,true, true,
